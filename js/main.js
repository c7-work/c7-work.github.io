...
$(function() {
  var bookmark = {
    data: [ {
      name: '导航站(本站)',
      link: 'https://www.iloli.love',
      icon: 'img/pic.png',
    },{
      name: '博客站',
      link: 'https://blog.iloli.love',
      icon: 'img/pic.png',
    },  {
      name: '音频站',
      link: 'https://audio.iloli.love',
      icon: 'img/pic.png',
    }, {
      name: '图片站',
      link: 'https://pic.iloli.love',
      icon: 'img/pic.png',
    }, {
      name: '网页小游戏站',
      link: 'https://game.iloli.love',
      icon: 'img/pic.png',
    }, {
      name: 'api站',
      link: 'https://api.iloli.love',
      icon: 'img/pic.png',
    }]
  }
  ...
  $(document).click(function(e) {
    ...
    for (var i = 0; i < search.data.length; i++) {
      if (id == search.data[i].name) {
        ...
        document.getElementById("Select").innerHTML = "<hr>本站站点(点击切换搜索引擎) <img src='img/search-change.svg?v=2ae7ab8'>";
...
var time = d.getHours();
if (time < 24) {
  document.getElementById("title").innerHTML = "萌新导航站 | Good evening";
}
if (time < 18) {
  document.getElementById("title").innerHTML = "萌新导航站 | Good afternoon";
}
if (time < 12) {
  document.getElementById("title").innerHTML = "萌新导航站 | Good morning";
}
if (time < 5) {
  document.getElementById("title").innerHTML = "萌新导航站 | Stay up late again";
}
//title问候语结束

//导航、引擎选择器
function select() {
  $('#folder').css('display') == 'block' ? ($('#folder').css('display', 'none'), $('#nav').css('display', 'block'), document.getElementById("Select").innerHTML = "<hr>搜索引擎(点击浏览本站站点) <img src='img/search-change.svg?v=2ae7ab8'>") : ($('#nav').css('display', 'none'), $('#folder').css('display', 'block'), document.getElementById("Select").innerHTML = "<hr>本站站点(点击切换搜索引擎) <img src='img/search-change.svg?v=2ae7ab8'>");
}
